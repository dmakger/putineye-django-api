...
from user.views.people import AllPeopleAPIView, AddPersonAPIView, UpdatePersonAPIView
...
urlpatterns = [
    ...
    path('admin/update/<int:pk>/', UpdateAdminAPIView.as_view(), name='update_admin_api'),
    ...
    path('ban/update/<int:pk>/', UpdatePeopleToBanAPIView.as_view(), name='update_ban_api'),
